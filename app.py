...
<style>
    ...
    .qty-label { z-index: 2; font-size: 12px; font-weight: bold; color: #d9480f; } /* 가독성을 위한 오렌지 브라운 */
...
def draw_silo(name, max_cap, connected=False):
    ...
    if info:
        ...
        <div class="silo {conn_cls}">
            ...
            <span style="font-size:8px; color:#adb5bd;">{max_cap}T</span>
        </div>
        """
...
st.markdown('<div class="section-title">Step 3. 전용 및 마이너 사일로 (Dedicated & Minor)</div>', unsafe_allow_